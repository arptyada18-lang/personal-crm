...
for(const f of ["app.js","v2.js","v3.js","v4.js","v5.js","v6.js","v7.js","sw.js"])new Function(read(f));
JSON.parse(read("manifest.json"));
const html=read("index.html"),css=read("style.css"),app=read("app.js"),v2=read("v2.js"),v3=read("v3.js"),v4=read("v4.js"),v5=read("v5.js"),v6=read("v6.js"),v7=read("v7.js"),sw=read("sw.js"),manifest=read("manifest.json");
["app.js","v2.js","v3.js","v4.js","v5.js","v6.js","v7.js"].forEach(f=>assert(html.includes('src="'+f+'"'),f+" not loaded"));
assert(html.includes('rel="manifest"'),"PWA manifest link missing");
assert(html.includes('icon.svg'),"PWA icon missing");
...
assert(sw.includes('personal-crm-v7'),"V7 cache name missing");
...
assert(css.includes("health-panel"),"V7 health styles missing");
assert(css.includes("snapshot-list"),"V7 snapshot styles missing");
assert(css.includes("pwa-status-grid"),"V7 PWA status styles missing");
assert(css.includes("@media(max-width:820px)"),"Responsive CSS missing");
console.log("Personal CRM V1-V7 smoke checks passed.");
